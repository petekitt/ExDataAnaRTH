...
ในการวิเคราะห์ข้อมูล อีกปัจจัยหนึ่งที่นักสถิติต้องให้ความสำคัญก็คือการกระจายตัวของข้อมูล ซึ่งเราสามารถวัดขนาดการกระจายตัวของข้อมูลจากค่าเฉลี่ยได้โดยการคำนวณค่าความผันผวน (`Variance`) และส่วนเบี่ยงเบนมาตรฐาน (`Standard Deviation` หรือ `SD`)
